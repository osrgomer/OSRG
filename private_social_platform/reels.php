...
$additional_css = '
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .toggle-create { position: fixed; top: 16px; right: 80px; background: #ff6b6b; color: white; border: none; padding: 8px 12px; border-radius: 20px; z-index: 1001; cursor: pointer; font-size: 12px; }
